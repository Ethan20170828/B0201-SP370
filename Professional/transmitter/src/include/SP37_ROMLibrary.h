...
// -----------------------
#define LFCDFLT_Time1 (0x580D)
#define LFCDFLT_Time2 (0x580C)
#define LFCDFLT_Time3 (0x580B)

#define CDETT_Level1 (0x5810)
#define CDETT_Level2 (0x580F)
#define CDETT_Level3 (0x580E)
...
#ifdef __C51__
   extern unsigned char ADC_Selftest (signed int idata *Delta);
#else
